-- -- D_ICD_POCEDURES dip
-- dip.ICD9_CODE   dip.LONG_TITLE
-- "9975"      	  "Administration of neuroprotective agent"

-- -- Memantine pharmacology
-- Memantine is a low-affinity voltage-dependent non-competitive antagonist at glutamatergic NMDA receptors.
-- Glutamateric:
...
-- Excessive doses of memantine (e.g. recreational use) may indeed activate Sigma-1 (https://erowid.org/experiences/subs/exp_Pharms_Memantine.shtml)

-- -- Unknown NMDAR/GluR interaction
-- Statins
-- ACEi/ARB
-- Ca++ channel blockers 
